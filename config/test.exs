...
config :caixa_azul, CaixaAzul.Repo,
  username: "postgres",
  password: "postgres",
  database: "caixa_azul_test#{System.get_env("MIX_TEST_PARTITION")}",
  hostname: "localhost",
...
config :caixa_azul, CaixaAzul.Mailer, adapter: Swoosh.Adapters.Test
